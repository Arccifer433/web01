...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "O64NatfbZr8bAGJlaUiGqZGZXhTWMbaE";
	...
	private List<Item> getItemList(JSONArray events) throws JSONException{
		...
		for (int i = 0; i<events.length(); ++i) {
			...
			builder.setCategories(getCatgories(event));
	...
	private Set<String> getCatgories(JSONObject event) throws JSONException {
